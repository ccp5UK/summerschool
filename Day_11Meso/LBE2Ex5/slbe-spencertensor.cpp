...
//    fWallInteractionForceLishchukLocal();    // Substitute with required mesophase interactions and/or add additional forces
    fCollisionBGKGuoLishchukLocal(); // Substitute with required collision and forcing algorithm
    fPostCollBoundary();
    fPropagationSwap();
    fPostPropBoundary();
  }
