...
module mc_module
  ...
  ! The calculation of delta NEEDS FIXING in this file.
...
contains
  ...
  subroutine v_move ( beta, pressure, dv_max, box, r, u, w, accepted ) ! Volume move
    ...
    delta = delta + beta * pressure * v_new ! This is the exp(-beta*P*Delta V) part (NEEDS FIXING, or does it?)
    delta = delta - n * log ( v_scale )     ! This is the (Vnew/Vold)**N part (NEEDS FIXING, or does it?)
