...
module mc_npt_module
  ...
  ! The calculation of delta is WRONG in this file.
  ! Can you fix it, referring to the equations given in the notebook?
...
contains
  ...
  subroutine v_move ( beta, pressure, dv_max, box, r, u, w, accepted ) ! Volume move
    ...
    delta = delta + beta * pressure * v_new ! This is the exp(-beta*P*Delta V) part (or is it?)
    delta = delta - n * log ( v_scale )     ! This is the (Vnew/Vold)**N part (or is it?)
