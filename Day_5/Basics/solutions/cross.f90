...
!***********************************************************************
    ...
    integer :: i, j, ncol1, ncol2, ndat
    real*8 :: dtim, time, sum1,sum2
    real*8 :: c(ndiv), u(ndiv), b(ndiv), t(ndiv), sample(3)
...
100 ndat = i - 1
    ...
    sum1 = sum1 / dble(ndat)
    sum2 = sum2 / dble(ndat)
    write(*,*)'Average u:', sum1
    write(*,*)'Average b:', sum2
