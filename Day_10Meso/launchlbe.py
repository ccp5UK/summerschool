...
def run_LBE(lbeexe='LBE', numstep=4000, description=''):
    """
    Launches CCP5 LBE code and displays a progress bar as it runs.
    ...
    """
    command = str(Path(lbeexe).resolve()) + " {0:d}".format(numstep)
